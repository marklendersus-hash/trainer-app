        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 space-y-4">
            ...
            <form id="mannschaftForm" class="space-y-3">
                <div>
                    ...
                    <input type="text" name="name" value="${state.teamInfo.name || ''}" class="w-full p-2 mt-1 bg-gray-100 dark:bg-gray-700 rounded-lg">
                </div>
                <div>
                    <label class="font-semibold text-sm">Mannschaftsname (Zeile 2)</label>
                    <input type="text" name="name2" value="${state.teamInfo.name2 || ''}" class="w-full p-2 mt-1 bg-gray-100 dark:bg-gray-700 rounded-lg">
                </div>
                <div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 space-y-4">
            ...
            <form id="trainingsForm" class="space-y-3">
                    ...
                    ['Montag', 'Dienstag', 'Mittwoch', 'Donnerstag', 'Freitag', 'Samstag', 'Sonntag'].map(tag => {
                        ...
                        return `
                            <div class="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <input type="time" name="zeit_${tag}" value="${timeValue}" class="p-1 bg-gray-100 dark:bg-gray-700 rounded-lg w-32 border dark:border-gray-600 focus:ring-green-500 focus:border-green-500">
                            </div>
                            `;
                    }).join('')
                }
                <div class="border-t dark:border-gray-700 pt-4">
                    ...
                    <input type="date" id="trainingEndDate" name="trainingEndDate" value="${state.teamInfo.trainingEndDate || ''}" class="w-full p-2 mt-1 bg-gray-100 dark:bg-gray-700 rounded-lg">
                </div>
