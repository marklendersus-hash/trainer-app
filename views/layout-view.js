...
export const renderHeader = (title) => {
    ...
    return `
    <header class="bg-gray-800 text-gray-200 p-4 fixed top-0 left-0 right-0 z-50 flex items-center justify-between text-center h-16 border-b-2 border-green-500">
