...
export const renderHeader = (title) => {
    ...
    return `
    <header class="bg-gray-800 text-gray-200 p-3 fixed left-0 right-0 z-50 flex items-end justify-between text-center h-32 border-b-2 border-green-500" style="top: -2px;">
        <div class="w-12 h-12">
